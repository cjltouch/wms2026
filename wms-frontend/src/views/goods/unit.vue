<template>
  <div class="page-container">
    ...
    <div class="action-bar">
      <el-button v-perm="'wms:unit:add'" type="primary" :icon="Plus" @click="handleAdd">新增</el-button>
      <el-button v-perm="'wms:unit:remove'" type="danger" :icon="Delete" :disabled="!selectedIds.length" @click="handleBatchDelete">批量删除</el-button>
    </div>
    ...
    <el-table v-loading="loading" :data="tableData" border stripe @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" width="160" align="center" fixed="right">
        <template #default="{ row }">
          <el-button v-perm="'wms:unit:edit'" link type="primary" :icon="Edit" @click="handleEdit(row)">编辑</el-button>
          <el-button v-perm="'wms:unit:remove'" link type="danger" :icon="Delete" @click="handleDelete(row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
