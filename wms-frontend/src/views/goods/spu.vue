<template>
  <div class="page-container">
    ...
    <div class="action-bar">
      <el-button v-perm="'wms:goods:add'" type="primary" :icon="Plus" @click="handleAdd">新增</el-button>
      <el-button v-perm="'wms:goods:export'" type="success" :icon="Download" @click="handleExport">导出商品</el-button>
      <el-button v-perm="'wms:goods:edit'" type="success" :icon="Top" :disabled="!selectedIds.length" @click="handleBatchStatus('0')">批量上架</el-button>
      <el-button v-perm="'wms:goods:edit'" type="warning" :icon="Bottom" :disabled="!selectedIds.length" @click="handleBatchStatus('1')">批量下架</el-button>
      <el-button v-perm="'wms:goods:remove'" type="danger" :icon="Delete" :disabled="!selectedIds.length" @click="handleBatchDelete">批量删除</el-button>
    </div>
    ...
    <el-table v-loading="loading" :data="tableData" border stripe @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" width="200" align="center" fixed="right">
        <template #default="{ row }">
          <el-button v-perm="'wms:goods:list'" link type="primary" :icon="View" @click="handleView(row)">查看</el-button>
          <el-button v-perm="'wms:goods:edit'" link type="primary" :icon="Edit" @click="handleEdit(row)">编辑</el-button>
          <el-button v-perm="'wms:goods:remove'" link type="danger" :icon="Delete" @click="handleDelete(row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
